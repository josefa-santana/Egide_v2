                        ...
                        <form method="POST" action="{{ route('login') }}" class="main-form text-center">
                            ...
                            <label for="remember_me" class="check_1">
                                <input id="remember_me" type="checkbox" checked class="form-check-input"
                                    name="remember">
                                <span class="ml-2 text-sm text-gray-600" style="color: #5337FF;">{{ __('Lembre-me') }}</span>
                            </label>

                            <!-- Button Login -->
                            <div class="form-group my-0">
                                @if (Route::has('password.request'))
                                <a class="text-sm text-light-600 hover:text-light-900" style="text-decoration:none; color: #5337FF;"
                                ...
                                <a href="{{ route('createregister') }}" style="text-decoration:none; color: #5337FF;">Cadastrar</a>
