      ...
      <div class="mt-4 align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="th">Id</th>
              <th class="th">Nome de apresentação</th>
              <th class="th">Nome</th>
              <th class="th"># Permissões</th>
              <th class="th"></th>
            </tr>
          </thead>
          <tbody class="bg-white">
            ...
            <tr>
              ...
              <td class="flex justify-end px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                ...
                <a href="{{route('laratrust.roles.edit', $role->getKey())}}" class="text-blue-600 hover:text-blue-900">Editar</a>
                @else
                <a href="{{route('laratrust.roles.show', $role->getKey())}}" class="text-blue-600 hover:text-blue-900">Detalhes</a>
                @endif
                <form
