...
@section('content')
  <div class="flex flex-col">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      ...
      >
        <span class="text-gray-700">Modelo de usuário para atribuir funções/permissões</span>
          ...
          <table class="min-w-full">
            <thead>
              <tr>
                <th class="th">Id</th>
                <th class="th">Nome</th>
                <th class="th"># Funççoes</th>
                @if(config('laratrust.panel.assign_permissions_to_user'))<th class="th"># Permissões</th>@endif
                <th class="th"></th>
              </tr>
            </thead>
